'''
    ...
    1.顺序搜索
        ...
        # 在知道列表是有顺序的前提下，[17,20.36.40,45,50,51,55,59,60]  50
        ...
        alist = [12,15,19,25,29,36,40,55,63,70]
    ...
    练习：
        [15,18,2,19,18,0,8,14,19,14],对其进行殊勋搜索，为了找到18，需要做多少次对比
        [3,4,6,8,11,12,14,15,17,18] 找到13，需要多少次对比？   7

    2.二分搜索:
        二分搜索将从中间开始检测，而不是按顺序搜索列表，如果查找项与我们刚搜索到的项匹配，则搜索结束，如果不匹配，我们可以利用列表的有序性来排除掉一半的剩余项
